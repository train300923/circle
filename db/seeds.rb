...
guilhem = User.create(first_name: 'guilhem', last_name: 'maffre', address: '12 rue des renardeaux 75011 paris', phone_number: '061245654348', biography: "j'ai pour habitude de me considerer comme un codeur fou", latitude: '48.86481', longitude: '2.38762', preferred_category: CATEGORY[2], email: 'guilhem@circle.com', password: 'password1')
kaouthar = User.create(first_name: 'kaouthar', last_name: 'elherch', address: '45 avenue du chateau 78000 versailles', phone_number: '0612486323', biography: "j'adore la gym!", latitude: '48.80528', longitude: '2.12227', preferred_category: CATEGORY[1], email: 'kaouthar@circle.com', password: 'password2')
ulrich = User.create(first_name: 'ulrich', last_name: 'johnson', address: '30 zedlitzgasse 1010 wien', phone_number: '0612486323', biography: "j'adore l'opera et la culture!", latitude: '48.20681', longitude: '16.37935', preferred_category: CATEGORY[2], email: 'ulrich@circle.com', password: 'password3')
sebastian = User.create(first_name: 'sebastian', last_name: 'kurz', address: 'rotgasse 10, 1010 Wien, Austria', phone_number: '0612486323', biography: "unique est la ville de vienne pour la culture", latitude: '48.21103', longitude: '16.37473', preferred_category: CATEGORY[2], email: 'sebastian@circle.com', password: 'password4')
tony = User.create(first_name: 'tony', last_name: 'de la casca', address: 'Habsburgergasse 7, 1010 Wien, Austria', phone_number: '0612486323', biography: "je suis ne et j'ai grandi dans cette ville qui est pour moi tout a fait speciale", latitude: '48.20809', longitude: '16.36825', preferred_category: CATEGORY[2], email: 'tony@circle.com', password: 'password5')
