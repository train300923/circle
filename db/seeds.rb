...
guilhem = User.create(first_name: 'guilhem', last_name: 'maffre', age: 32, job: 'codeur professionnel', address: '12 rue des renardeaux 75011 paris', phone_number: '061245654348', biography: "j'ai pour habitude de me considerer comme un codeur fou", latitude: '48.86481', longitude: '2.38762', preferred_category: CATEGORY[2], email: 'guilhem@circle.com', password: 'password1')
guilhem_photo = URI.open("https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1695973943/akaaeorc4t5itswatebm.jpg")
guilhem.photo.attach(io: guilhem_photo, filename: "guilhem.png", content_type: "image/png")
...
ulrich = User.create(first_name: 'ulrich', last_name: 'johnson', age: 52, job: 'archeveque', address: '30 zedlitzgasse 1010 wien', phone_number: '0612486323', biography: "j'adore l'opera et la culture!", latitude: '48.20681', longitude: '16.37935', preferred_category: CATEGORY[2], email: 'ulrich@circle.com', password: 'password3')
ulrich_photo = URI.open("https://wp.fr.aleteia.org/wp-content/uploads/sites/6/2022/04/MGR-ULRICH-Brigitte-Naye-diocese-de-Lille.jpg")
ulrich.photo.attach(io: ulrich_photo, filename: "ulrich.png", content_type: "image/png")
sebastian = User.create(first_name: 'sebastian', last_name: 'kurz', age: 33, job: 'ex prime minister', address: 'rotgasse 10, 1010 Wien, Austria', phone_number: '0612486323', biography: "unique est la ville de vienne pour la culture", latitude: '48.21103', longitude: '16.37473', preferred_category: CATEGORY[2], email: 'sebastian@circle.com', password: 'password4')
sebastian_photo = URI.open("https://upload.wikimedia.org/wikipedia/commons/8/82/Sebastian_Kurz_%282018-02-28%29_%28cropped%29.jpg")
sebastian.photo.attach(io: sebastian_photo, filename: "sebastian.png", content_type: "image/png")
tony = User.create(first_name: 'tony', last_name: 'de la casca', age: 40, job: 'ex basketballer pro', address: 'Habsburgergasse 7, 1010 Wien, Austria', phone_number: '0612486323', biography: "je suis ne et j'ai grandi dans cette ville qui est pour moi tout a fait speciale", latitude: '48.20809', longitude: '16.36825', preferred_category: CATEGORY[2], email: 'tony@circle.com', password: 'password5')
tony_photo = URI.open("https://www.gala.fr/imgre/fit/~1~gal~2023~09~20~cdaeaaea-9457-441f-848a-7b80c4b35b82.jpeg/2764x2151/quality/80/tony-parker.jpeg")
tony.photo.attach(io: tony_photo, filename: "tony.png", content_type: "image/png")
julien = User.create(first_name: 'julien', last_name: 'rodot', age: 38, job: 'chanteur', address: 'Schubertring 13, 1010 Wien, Austria', phone_number: '0612486323', biography: "nouveau venu dans cette ville, j'aimerai rencontrer de nouvelles personnes ayant des interets communs", latitude: '48.20206', longitude: '16.37481', preferred_category: CATEGORY[0], email: 'julien@circle.com', password: 'password6')
julien_photo = URI.open("https://img.nrj.fr/XxMNJTYk-pk7z2NVVVVQXMoAcgc=/medias%2F2022%2F10%2F634012f3384d1_634012f5da92f.jpg")
