...
crossfit = Activity.create(name: 'Gymclub de Perros-Guirec', category: 'Crossfit', description: 'Activite de gym tres energetique qui va vous faire demarrer la journee sur le bon pied!', price: '10€', address: "15 Rue d'Anjou 78000 Versailles", latitude: '48.79739', longitude: '2.12640')
...
opera = Activity.create(name: 'Opera Garnier', category: 'Opera', description: 'Magnifique opera "Lac des Cygnes", standing ovation!', price: '80€', address: "Place de l'Opera 75009 Paris", latitude: '48.87266', longitude: '2.33276')
