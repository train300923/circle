...
tennis1 = Activity.create(name: 'Tennis Club du Tourniquet', category: CATEGORY[1], description: 'Venez profitez de nos superbes equipements sportifs ainsi que de notre proximite avec le lac d Annecy', price: 40, address: '40 Rue de Verdun 74940 Annecy-le-Vieux', latitude: '45.91032', longitude: '6.15853')
...
tennis2 = Activity.create(name: 'Oswald Tennis Club', category: CATEGORY[1], description: 'Magnifique complexe sportif tres moderne, il y a plus de 10 terrains', price: 35, address: 'Hauptallee, 1020 Wien, Austria', latitude: '48.19552', longitude: '16.43879')
...
tennis3 = Activity.create(name: 'Tennis Club de Beziers', category: CATEGORY[1], description: 'Club tres dynamique accueillant la Nestea Cup, vous serez tres bien recu. Nous avons 10 terrains greenset, quick et terre battue', price: 20, address: '15 avenue jean-baptiste blattes 34500 Béziers', latitude: '43.34011', longitude: '3.19099')
...
crossfit1 = Activity.create(name: 'Gymclub de Versailles', category: CATEGORY[2], description: 'Activite de gym tres energetique qui va vous faire demarrer la journee sur le bon pied!', price: 10, address: "15 Rue d'Anjou 78000 Versailles", latitude: '48.79739', longitude: '2.12640')
...
crossfit2 = Activity.create(name: 'Mrs.Sporty Club Wien', category: CATEGORY[2], description: 'Super content que vous veniez sur notre page! Vous trouverez ici tous les modules prets pour vous entrainer', price: 13, address: "Porzellangasse 33A, 1090 Wien, Austria", latitude: '48.23051', longitude: '16.36943')
...
crossfit3 = Activity.create(name: 'Gymclub de Reims', category: CATEGORY[2], description: 'Tout simplement le meilleur club de France! Rejoignez nous des maintenant!', price: 8, address: "8 Allee du Vignoble 51100 Reims", latitude: '49.22154', longitude: '4.01964')
...
crossfit4 = Activity.create(name: 'Gymclub d Avignon', category: CATEGORY[2], description: 'Les papes, c etait avant, maintenant ici, c est la capitale de la levee de fonte! ', price: 17, address: "162 Avenue Pierre Semard 84000 Avignon", latitude: '43.92925', longitude: '4.83410')
...
opera1 = Activity.create(name: 'Volkstheater', category: CATEGORY[3], description: 'Magnifique opera "Lac des Cygnes", standing ovation!', price: 80, address: "Arthur-Schnitzler-Platz 1, 1070 Wien, Austria", latitude: '48.20497', longitude: '16.35741')
...
opera2 = Activity.create(name: 'Burgtheater', category: CATEGORY[3], description: 'Representations d opera tout simplement grandiose!', price: 75, address: "Universitätsring 2, 1010 Wien, Austria", latitude: '48.21180', longitude: '16.36283')
...
opera3 = Activity.create(name: 'Theater an der Wien', category: CATEGORY[3], description: 'On ne presente plus le Theater an der Wien! Les plus prestigieuses pieces et concerts se sont produits ici', price: 130, address: "Linke Wienzeile 6, 1060 Wien, Austria", latitude: '48.19930', longitude: '16.36371')
...
opera4 = Activity.create(name: 'Vienna State Opera', category: CATEGORY[3], description: 'Toute la rigueur autrichienne dans ce lieu mythique', price: 150, address: "Opernring 2, 1010 Wien, Austria", latitude: '48.20330', longitude: '16.36899')
